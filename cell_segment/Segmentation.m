...
overlayImg = im2double(imread(sprintf('images/merge %s 10x.tif', name)));
...
imgSet = {cellBoundaryImg, nucleiImg, overlayImg};
...
%draw the num of nuclei in each cell
...
%%
% Add feature: surf key points
cellProps = addRegionSurf(overlayImg, cellProps);
...
%savedFilename = strcat('newFeatures2/',name,'.mat');
