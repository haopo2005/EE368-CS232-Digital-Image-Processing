...
def main():
    ...
    kyleOutputVideo = cv2.VideoWriter('../jst_output/BallOutputKyle.mp4',fourcc, 60.0, (1920,1080));
    meganOutputVideo = cv2.VideoWriter('../jst_output/BallOutputMegan.mp4',fourcc, 60.0, (1920,1080));
    meganFilename = '../Stereo_Clips/stereoClip3_Megan.mov'
    kyleFilename = '../Stereo_Clips/stereoClip3_Kyle.mov'
    ...
    cfMegan.FindCourtCorners(frame, 1)
    ...
    with open('../jst_output/ballEst.csv', 'wb') as csvfile:
